# Copyright (C) 2018-2022 The RyzenOS Project
#
...
TOOLS_PATH_OVERRIDE := \
    PERL5LIB=$(BUILD_TOP)/prebuilts/tools-ryzen/common/perl-base
...
ifeq (,$(filter 5.10, $(TARGET_KERNEL_VERSION)))
    ...
    ifeq ($(KERNEL_ARCH),arm64)
        ...
        TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-ryzen/$(HOST_PREBUILT_TAG)/bin:$(KERNEL_TOOLCHAIN_arm):$$PATH
    else
        TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-ryzen/$(HOST_PREBUILT_TAG)/bin:$$PATH
    endif
    ...
    TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-ryzen/$(HOST_PREBUILT_TAG)/bin:$(TARGET_KERNEL_CLANG_PATH)/bin:$$PATH
endif
